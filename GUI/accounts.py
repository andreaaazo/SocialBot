...
class account(Frame):
    def __init__(self, container, accountnumber):
        ...
        class SocialAccount(LabelFrame):
            def __init__(
                self,
                container,
                button_title,
                ...
                self.description.bind(
                    "<FocusOut>",
                    lambda event: focusOut(self.description, "Post description"),
                )
                ...
                self.getVideoPath.grid(row=2, column=0, ipadx=100, ipady=5, pady=5)
        ...
        self.tiktok_account = SocialAccount(
            self,
            "with Facebook",
        ...
        self.tiktok_account.grid_forget()

        self.instagram_account = SocialAccount(
            self,
            "with Instagram",
        ...
        self.instagram_account.grid_forget()

        self.accounts = {
            "TikTok": self.tiktok_account,
            "Instagram": self.instagram_account,
        }
